...
MLB の打撃動画 clip と Statcast BBE データを結び付け、打球指標と選手シーズン成績を予測・比較する Google Colab / Google Drive 用のパイプラインです。
...
- レポート: `reports/v2_research_deep_dive/deep_research_document_ja.html`
